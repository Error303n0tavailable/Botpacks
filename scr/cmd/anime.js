...
module.exports = {
    ...
    start: async function ({ api, event, text, reply }) {
        ...
        try {
            ...
            const apiUrl = `https://samirxpikachu.onrender.com/animagine?prompt=${encodeURIComponent(prompt)}`;
            ...
            const pathh = __dirname + "/cache/generated-animation.png"; // Assuming it's a GIF based on the API endpoint
